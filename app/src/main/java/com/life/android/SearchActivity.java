...
import com.life.android.widget.RangeSeekBar;
...
public class SearchActivity extends AppCompatActivity {
    ...
    private TextView search_btn, clear_btn;
    ...
    private void initComponent() {
        ...
        genreSpinner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                builder.setTitle(Html.fromHtml("<font color='#000000'>Select Genre</font>"));
        ...
        tvCategorySpinner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(SearchActivity.this);
                builder.setTitle(Html.fromHtml("<font color='#000000'>Select Tv Category</font>"));
        ...
        countrySpinner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(SearchActivity.this);
                builder.setTitle(Html.fromHtml("<font color='#000000'>Select Country</font>"));
