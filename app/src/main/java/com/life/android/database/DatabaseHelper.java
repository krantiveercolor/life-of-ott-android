package com.life.android.database;
...
import com.life.android.models.Work;
import com.life.android.network.model.ActiveStatus;
import com.life.android.network.model.config.AdsConfig;
import com.life.android.network.model.config.AppConfig;
...
*/
    ...
    public long insertUserData(User user) {
        ...
        contentValues.put(USER_COLUMN_PROFILE_IMAGE_URL, user.getImage_url());
        contentValues.put(USER_COLUMN_USER_ID, user.getUser_id());
    ...
    public User getUserData() {
        ...
        if (cursor != null)
            if (cursor.moveToFirst()) {
                while (!cursor.isAfterLast()) {
                    // prepare appConfig object
                    user.setUser_id(cursor.getString(cursor.getColumnIndex(USER_COLUMN_USER_ID)));
                    ...
                    user.setImage_url(cursor.getString(cursor.getColumnIndex(USER_COLUMN_PROFILE_IMAGE_URL)));
