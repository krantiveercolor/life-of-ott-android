...
public class ActiveSubscription implements Parcelable {
    ...
    protected ActiveSubscription(Parcel in) {
        ...
        paymentTimestamp = in.readString();
        status = in.readString();
    }

    public static final Creator<ActiveSubscription> CREATOR = new Creator<ActiveSubscription>() {
        @Override
        public ActiveSubscription createFromParcel(Parcel in) {
            return new ActiveSubscription(in);
        }

        @Override
        public ActiveSubscription[] newArray(int size) {
            return new ActiveSubscription[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(paymentTimestamp);
