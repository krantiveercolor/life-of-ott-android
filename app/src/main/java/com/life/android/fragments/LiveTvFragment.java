...
import com.life.android.adapters.LiveTvCategoryAdapter;
import com.life.android.network.RetrofitClient;
import com.life.android.network.apis.LiveTvApi;
import com.life.android.network.model.LiveTvCategory;
...
//        menuIv = view.findViewById(R.id.bt_menu);
        pageTitle = view.findViewById(R.id.toolbar_title_view);
        //      searchIv = view.findViewById(R.id.search_iv);
        view.findViewById(R.id.toolbar_back_btn).setOnClickListener(view1 -> requireActivity().onBackPressed());
