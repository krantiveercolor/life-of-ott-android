...
import com.life.android.models.home_content.PopularStars;
...
import static com.life.android.ItemMovieActivity.INTENT_TYPE_STAR;
...
public class PopularStarAdapter extends RecyclerView.Adapter<PopularStarAdapter.StarViewHolder> {
    ...
    public void onBindViewHolder(@NonNull StarViewHolder holder, int position) {
        if (starsList != null) {
            ...
            Picasso.get().load(star.getImageUrl())
                    .resize(100,100)
