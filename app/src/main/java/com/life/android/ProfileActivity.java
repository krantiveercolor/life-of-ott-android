...
import com.life.android.network.apis.DeactivateAccountApi;
import com.life.android.network.apis.ProfileApi;
import com.life.android.network.apis.SetPasswordApi;
...
import com.life.android.utils.FileUtil;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                updateProfile(id, email, phone, name);
            }
        });
        ...
        genderSpinner.setOnClickListener(v -> {
            ...
            builder.setSingleChoiceItems(genderArray, -1, (dialogInterface, i) -> {
    ...
    private void updateProfile(String idString, String emailString, String phoneString, String nameString) {
        File file = null;
